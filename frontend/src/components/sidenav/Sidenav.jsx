...
function Sidenav() {
  ...
  return (
    <>
      {/* Hamburger button: should appear on smaller screens */}
      <div className="hamburger" onClick={toggleSidebar}>
        <FaBars />
      </div>

      <div className={`sidenav-main-container ${isOpen ? "open" : ""}`}>
        <div className="sidenav-profile-container">
          <img className="sidenav-profile-img" src={profile} alt="Profile" />
          <p className="sidenav-profile-name">USER</p>
          <p className="sidenav-profile-email">user@gmail.com</p>
        </div>
        <div className="sidenav-list-main-container">
          <Link to="/admin/dashboard">
            <div
              className={`sidenav-list ${
                location.pathname === "/admin/dashboard" ? "default-hover" : ""
              }`}
            >
              <span>
          ...
          <Link to="/admin/employees">
            <div
              className={`sidenav-list ${
                location.pathname === "/admin/employees" ? "default-hover" : ""
              }`}
            >
              <span>
          ...
          <Link to="/admin/projects">
            <div
              className={`sidenav-list ${
                location.pathname === "/admin/projects" ? "default-hover" : ""
              }`}
            >
              <span>
          ...
          <Link to="/admin/tasks">
            <div
              className={`sidenav-list ${
                location.pathname === "/admin/tasks" ? "default-hover" : ""
              }`}
            >
              <span>
          ...
          <Link to="/admin/timesheets">
            <div
              className={`sidenav-list ${
                location.pathname === "/admin/timesheets" ? "default-hover" : ""
              }`}
            >
              <span>
          ...
          <Link to="/admin/attendance">
            <div
              className={`sidenav-list ${
                location.pathname === "/admin/attendance" ? "default-hover" : ""
              }`}
            >
              <span>
