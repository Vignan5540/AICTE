...
function AddTaskModal({ isOpen, onClose }) {
  ...
  // IMPORTANT: Use a leading slash in the URL!
  const getEmployees = async () => {
    try {
      const response = await axios.get('/api/employees'); // Note the slash
      setEmployeesData(response.data); // Ensure this data is an array
    } catch (error) {
  ...
  const getProjects = async () => {
    try {
      const response = await axios.get('/api/projects'); // Note the slash
      setProjectsData(response.data); // Your backend sends an array via res.send(projects)
    } catch (error) {
