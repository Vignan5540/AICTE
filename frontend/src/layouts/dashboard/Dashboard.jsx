        ...
        <div className='app-main-right-container'>
          ...
          <div className='welcome-main-container'>
            <div className='welcome-left-container'>
              ...
              <p className='mng-text'>Project Management  </p>
              <p className='mng-para'>In this project management hub, the system seamlessly orchestrates task creation, assignment, and tracking, ensuring projects move forward smoothly and collaboratively.</p>
            </div>
